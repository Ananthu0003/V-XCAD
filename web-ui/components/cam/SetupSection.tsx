import type { SetupSettings, StockType, MaterialType, WorkCoordinateSystem, OriginPosition } from '@/types/cam';
				...
				<div className="grid grid-cols-3 gap-2">
					<div className="flex flex-col gap-1">
						...
						<input
							...
							className="w-full bg-[#050814] border border-[#1e293b] rounded-lg px-3 py-2 text-xs font-mono text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 outline-none transition-all shadow-inner"
						/>
					</div>
					<div className="flex flex-col gap-1">
