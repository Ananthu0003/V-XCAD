            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="flex flex-col gap-4">
                ...
                <FeatureOverviewSection
                  ...
                  isAutoGenerateDisabled={!(props.camSetup.machineProfile || props.camSetup.machineProfileId || props.camSetup.machine) || !(props.camSetup.material || props.camSetup.workpieceMaterialId)}
                />
              </div>
              <div className="flex flex-col gap-4">
