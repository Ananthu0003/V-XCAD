                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    {isLoading ? (
                        ...
                        sessions.map((session) => (
                            <div 
                                key={session.id}
                                className="group p-4 bg-zinc-900/50 border border-zinc-800 rounded-xl hover:border-blue-500/50 transition-all cursor-pointer"
                            ...
                            >
                                <div className="flex justify-between items-start mb-2">
                                    ...
                                    <RotateCcw className="w-4 h-4 text-zinc-600 group-hover:text-blue-500 transition-colors" />
                                </div>
